    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-8">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-600 mb-8">
          ...
          <br /> Use the role toggle in the top-right corner to test different
          permission levels.
        </p>
        ...
        <div className="mt-8 p-4 bg-blue-50 rounded-lg">
          ...
          <ol className="text-sm text-blue-800 text-left space-y-1">
            <li>
              1. Use the role toggle (top-right) to switch between Guest, User,
              and Admin
            </li>
            <li>2. Try accessing /admin with different roles</li>
            <li>3. Notice how the admin area only appears for admin users</li>
            <li>
              4. Test navigation between admin pages when you have admin access
            </li>
          </ol>
        </div>
      </div>
